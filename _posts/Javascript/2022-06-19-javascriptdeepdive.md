...
____12.4.5 화살표 함수  
12.5 함수 호출  
[____12.5.1 매개변수와 인수 🔍](https://sunghwancode.github.io/javascript/parameter,argument/){:target='_blank'}
____12.5.2 인수 확인  
...
12.7 다양한 함수의 형태  
____12.7.1 즉시 실행 함수  
[____12.7.2 재귀 함수 🔍](https://sunghwancode.github.io/javascript/recursion/){:target='_blank'}
____12.7.3 중첩 함수  
[____12.7.4 콜백 함수 🔍](https://sunghwancode.github.io/javascript/callbackfunction/){:target='_blank'}
...
____19.11.2 객체 리터럴 내부에서 `__proto__`에 의한 직접 상속  
19.12 정적 프로퍼티/메서드  
19.13 프로퍼티 존재 확인  
____19.13.1 in 연산자  
